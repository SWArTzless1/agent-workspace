...
Once all items pass, write the solution to the `### Solution (Design Agent)` sub-section of the `## Design Plan` section in `projects/<project-name>/plans/<plan-name>.md`.
...
Written to `projects/<project-name>/docs/design-spec.md` (or `projects/<project-name>/plans/<project-name>-design-spec.md` if no project folder exists).
...
---
*Generated by Design Agent · Plan file: `projects/<project-name>/plans/<plan-name>.md`*
```
...
---
*Created by Design Agent · Plan file: `projects/<project-name>/plans/<plan-name>.md`*
```
